...
export const SidebarHeaderIcon = styled(({ className, ...props }) => (
  <ListItemIcon {...props} className={className} />
))(({ theme }) => ({
  minWidth: 30,
}));

export const SidebarItemIcon = styled(({ className, ...props }) => (
  <ListItemIcon {...props} className={className} />
))(({ theme }) => ({
  minWidth: 30,
}));

export const SidebarSubItemIcon = styled(({ className, ...props }) => (
  <ListItemIcon {...props} className={className} />
))(({ theme }) => ({
  minWidth: 30,
}));
