...
const QuickLinkCard = ({ href, title, description, Icon, colorName, iconColor, backgroundPercentage }) => {
  ...
  return (
    <article className="d-flex col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
